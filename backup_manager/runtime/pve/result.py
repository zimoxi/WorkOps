"""
WorkOps PVE Runtime Result — PVE 运行时结果
...
class PVERuntimeResult:
    ...
    def __post_init__(self):
        ...
        if not isinstance(self.success, bool):
            raise InvalidPVERuntimeSessionError("success must be a bool")
        if not isinstance(self.message, str):
            raise InvalidPVERuntimeSessionError("message must be a string")
